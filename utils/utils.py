                    ...
                    resource_metrics_list.append(
                        {
                            ...
                            'namespace': query_idx[result['Id']]['MetricStat']['Metric']['Namespace'],
                            'metric': query_idx[result['Id']]['MetricStat']['Metric']['MetricName'],
                            'instance': instance_value if instance_value else '',
                            'unit': metric['aws_unit'] if not metrics_list else query_idx[result['Id']]['MetricStat']['Metric']['MetricName'].split('_')[-1].capitalize(),
